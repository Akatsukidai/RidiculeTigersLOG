...
NDefines.NProduction.DEFAULT_MAX_NAV_FACTORIES_PER_LINE = 2 
...
NDefines.NProduction.BASE_FACTORY_SPEED_NAV = 6
...
--************************************** COMBAT ***********
NDefines.NMilitary.COMBAT_VALUE_STR_IMPORTANCE = 1.2
----------
...
NDefines.NMilitary.BASE_CAPTURE_EQUIPMENT_RATIO = 0.005
----------
...
NDefines.NMilitary.TRAINING_ATTRITION = 0.1
